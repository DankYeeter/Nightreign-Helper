...
# armament the game offers two-handed, "323 1H / 339 2H" inside the bold, the
# `1H` mark on the first figure and the `/ 339 2H` twin together in a quiet
# span while the switch stands on `1H` (AK-286, AK-298, AK-299,
