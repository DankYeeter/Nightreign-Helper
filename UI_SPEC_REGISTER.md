...
| AK-276 | Ort: Picker-Karte und `Why`-Dialog, an der Effekt-Id (nicht an der Zeile), drei Zustaende (neutral/Don't include/Must include, gegenseitig ausschliessend), ersetzt AD-035s reading-Mechanik in der Oberflaeche | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-277 | die Kontrolle ist der Aufzaehlpunkt selbst (kein Breitenzuwachs); drei Zustaende ueber bestehende Farben `ACCENT`/`BAD`/`MUTED`, keine neuen Hex-Werte; Tooltip je Zustand, zweite Legendenzeile im `Why`-Dialog | UI_SPEC §6.8 | T-248, 2026-09-14 | Tooltip-Wortlaut im ausgeschlossenen Zustand korrigiert (Nachtrag T-251c, Zyklus fuehrt zu Must include statt „normal zaehlend", DR-026) |
| AK-278 | Tastaturbedienung/Fokusring der Kontrolle wie jede andere Beraterhandlung (AK-25/AK-26); Zahl der Tab-Stopps je Karte wird beim ersten Bau gemessen | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-279 | die 4.9b-Liste (`not_counted`) bekommt zwei Verwaltungslisten `Effects you've excluded:`/`Effects you require:`, jede Zeile mit derselben Kontrolle — der Rueckweg, ohne zur urspruenglichen Karte zurueckzumuessen | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-280 | Zaehler nur im Zeilen-Tooltip (`bar.toolTip()`), kein neues Bedienelement, keine neue Breitenanforderung; sichtbar in allen 14 Zustaenden aus §4, nicht nur in Vorschlagszustaenden | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-281 | unerfuellbarer Pflicht-Effekt nennt sich beim Namen (A7/A12), Wortvorschlag nach AK-265-Muster; ob 4.10/4.11 oder ein eigener Zustand traegt, entscheidet der `architect` (AD-036) | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-282 | A12-Abgrenzung: Markierung wirkt nur auf `AdvisorRequest`/Berater, nicht auf das Werteblatt und seine `declared`-Schalter (`statsheet.py`); Nicht-Ziel bestaetigt (keine Reliktsperrliste, kein Klassen-Schalter) | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-283 | Persistenz ist sichtbares Verhalten (Neustart zeigt dieselben Markierungen ohne Zutun); Speicherschema entscheidet AD-036 | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
| AK-284 | A8 — alle neuen Zeichenketten aus AK-276 bis AK-283 Englisch, `html.escape`/`setTextFormat`-Disziplin wie AK-29/AK-30/AK-53 | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
