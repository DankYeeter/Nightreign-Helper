...
| AK-194 | die Statuszeile darf an der abgeleiteten Startbreite (wie AK-05), gemessen am laufenden Fenster, nie auf 0 px fallen (> 0 px); kein Kurzform-Rueckfall. | A21 Z5780 + A31 (Schwelle gesenkt) + A32 (Kurzform gestrichen, Bezugsbreite entschieden), beide T-226 | T-226, 2026-09-13 | entschieden A32 (Nachtrag zu T-226, 13.09.2026) — nicht mehr widerspruechlich |
...
| AK-302 | Neuer, staendig sichtbarer `QPushButton("Filters")` in der Leiste, ausserhalb des AK-07-Drei-Knopf-Budgets, aktiv auch waehrend `Optimize`; Symbolwahl Text statt Icon begruendet; AK-280-Zaehlerklausel wandert vom Zeilen-Tooltip zu diesem Knopf; Breitenfolge an AK-05/AK-194/A14 im ersten Baubericht real nachzumessen | UI_SPEC §3.6 | T-277a, 2026-09-15 | — |
