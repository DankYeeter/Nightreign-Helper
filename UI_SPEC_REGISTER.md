...
| AK-277 | die Kontrolle ist der Aufzaehlpunkt selbst (kein Breitenzuwachs); drei Zustaende ueber bestehende Farben `ACCENT`/`BAD`/`MUTED`, keine neuen Hex-Werte; Tooltip je Zustand, zweite Legendenzeile im `Why`-Dialog | UI_SPEC §6.8 | T-248, 2026-09-14 | — |
