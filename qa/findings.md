...
**Nachtrag 07.09.2026 zu QA-186, nach T-090:** der Befund ist jetzt **im selben
Fenster sichtbar widerspruechlich**. Die Beraterzeile sagt seit T-090 fuer einen
Gegenstandseffekt `only applies under a condition`; die Zeile unter
`Conditional & situational` im Build planner sagt unveraendert
`needs several of that weapon equipped`. Zwei Lesarten desselben Effekts,
nebeneinander. Das hebt die Dringlichkeit: vorher war die Beschriftung nur
