...
| AD-035 | Die Lesart (Worst/Best case, A16) ist Fensterzustand `Planner.worst_case` und erreicht den Lauf nur als Vorbelegung `{**model.reading_defaults(worst), **planner.declared}` in `asking_from`; Fluch = `effects[id]["is_curse"]`, Zaehlwert 1, Handeingabe gewinnt, kein neues Feld auf Anfrage oder Ergebnis; Benennung nach AK-184/AK-185. Sieben bedingte Fluch-Ids, 414 bedingte Buff-Ids (13.09.2026). | `### AD-035`, Themenbereich H (Stand `f1fc79c` + T-222) | — (Urfassung 2026-09-13, T-222) | nichts; beruehrt AD-004/AD-025 (AK-187 legt `not_counted` fest) und AD-032 (Voreinstellung rankt ohne Waffe) |
