...
T-236 **erledigt ohne Code** (alle fuenf bereits behoben, Waechterluecke QA-128 Pkt 10 → Fixauftrag nach Pruefphase) · T-237 **erledigt** `557eefe` (QA-229/QA-230 behoben `5dd0cf7`, zwei Mutationen lebend → QA faehrt nach; QA-141/QA-144/DR-016 seit 05.09. behoben; Suite **1526 passed / 9 skipped**, Director). Spec-Nachtrag fuer den `ui-ux-designer`: AK-262 (`BEST FOR ATTRIBUTES` passt in 118 px), DR-013..016 Status. Danach Beta-Gate (Audit, Pruefrollen in
