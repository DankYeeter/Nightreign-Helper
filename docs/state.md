...
**Nummernkreise** (nachgezaehlt 12.09. am Register): T ab **T-228** · QA ab
**QA-249** · SEC ab **SEC-043** · AK **AK-264** · AD **AD-036** · OF **OF-36**
...
`developer` klein AD-033 Punkt 2 (**erledigt** `64dd006`, ff-merged: `mutate.py` 5464 → 158 Zeilen, **301** Eintraege entfernt, nicht 289 wie AD-033 sagt — Archiv `git show f1fc79c:scripts/differential/mutate.py`; Suite im Worktree 1501 passed / 10 skipped, Director nicht nachgemessen). **T-224 A16 gebaut** (`9069d83` gemerged, 4 Commits, +482/-52, vier Mutationen getoetet), Suite im Worktree **1 failed / 1509 passed / 9 skipped** — der Fehlschlag ist der AK-05-Waechter (zweite Box laesst der Statuszeile 0 px offscreen, 37 px am Fenster). **Nutzerentscheidung 13.09.:** 1320 px aufgeben, Statuszeile darf schrumpfen (AK-05 auf A14-Startbreite, AK-194 auf > 0 px). Dazu 312 Relikte in `GOAL.md` nachgetragen (`541bba8`). T-226 (`4017938`: AK-05 auf A14-Startbreite, AK-194 > 0 px, AK-268) und AD-035-Nachtrag (`1a37481`) **erledigt**. **T-225 teilweise, ff-merged `ffc0a4c`** (AK-264/266/267/268 gebaut, AK-05/194-Waechter am laufenden Fenster im Kindprozess `tests/advisor_row_at_the_window.py`); Suite auf HEAD **1 failed / 1517 passed / 9 skipped** (Director gemessen) — der rote Test ist **QA-248** (Vorschlagszustand 683 px > 498 px). **Nutzerentscheidungen 13.09.:** Startbreite aus Leiste und Tabelle ableiten (T-227 `developer` klein) · Kurzform `Worst`/`Best` gestrichen (A32 `785b9b9`; AK-05/AK-194 aus der Widerspruch-Liste, es bleibt **AK-160** — Bezugsbreite folgt AK-05, die AK-189-Haelfte prueft der `ui-ux-designer` im Review am Gate). Mutationen d/e von T-225 nur per Kopie rot gezeigt — QA faehrt nach. Offener Zaehlauftrag: AK-188/AK-169-Zahlen (67/42/426/323) auf 312 Kopien nachzaehlen — in der Pruefphase. Dann AD-034 Schritt 1-3,
...
3. **Ein `widerspruechlicher` Fall** bleibt im AK-Register: AK-160 (`UI_SPEC.md:101`); AK-05/AK-194 am 13.09. entschieden.
